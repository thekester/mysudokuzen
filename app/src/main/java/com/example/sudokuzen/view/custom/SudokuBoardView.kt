...
class SudokuBoardView(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val size = min(width, height) // Keep the view square
    ...
    private fun drawLines(canvas: Canvas) {
        // 1️⃣ Dessiner d'abord toutes les lignes fines pour structurer la grille
        ...
        // 2️⃣ Ensuite, dessiner uniquement les lignes épaisses qui séparent les blocs 3x3
        for (i in 0..size step sqrtSize) {
            canvas.drawLine(
                i * cellSizePixels,
                0F,
                i * cellSizePixels,
        ...
        // 3️⃣ Enfin, tracer la bordure extérieure pour bien encadrer la grille
